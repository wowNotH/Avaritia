...
public class ContainerDireCrafting extends Container {
	...
	public ContainerDireCrafting(InventoryPlayer player, World world, BlockPos pos, TileDireCraftingTable table) {
		worldObj = world;
		this.pos = pos;
