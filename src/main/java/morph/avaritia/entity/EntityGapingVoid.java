				...
				for (int z = -blockrange; z <= blockrange; z++) {
					for (int x = -blockrange; x <= blockrange; x++) {
						...
						if (dist <= nomrange && !world.isAirBlock(blockPos)) {
							...
							float resist = state.getBlock().getExplosionResistance(this);//TODO HELP state.getExplosionResistance(this, this.world, lx, ly, lz, this.posX, this.posY, this.posZ);
							if (resist <= 10.0) {
