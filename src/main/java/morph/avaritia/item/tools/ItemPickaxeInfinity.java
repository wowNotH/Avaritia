...
public class ItemPickaxeInfinity extends ItemPickaxe {
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
		if (player.isSneaking()) {
			...
			if (EnchantmentHelper.getEnchantmentLevel(Enchantments.FORTUNE, player.getHeldItem(hand)) < 10) {
				player.getHeldItem(hand).addEnchantment(Enchantments.FORTUNE, 10);
			}
