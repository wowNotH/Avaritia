...
public class ItemBowInfinity extends Item implements ICosmicRenderItem, IModelRegister, IBakeryProvider {
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
		...
		ActionResult<ItemStack> event = ForgeEventFactory.onArrowNock(player.getHeldItem(hand), world, player, hand, true);
		if (event != null) {
			return event;
		}
	...
	public void registerModels() {
		/*
		SubBlockBakery.registerItemKeyGen(this, stack -> {
		...
		*/
		SubBlockBakery bakery = new SubBlockBakery();
		bakery.registerItemKeyGen(getContainerItem());
