...
public class ItemResource extends ItemMultiType implements IHaloRenderItem, IModelRegister {
	...
	public void registerModels() {
		...
		for (int meta = 0; meta < 8; meta++) {
			...
			final ModelResourceLocation location = new ModelResourceLocation("avaritia:resource", "type=" + name);
			...
			ModelLoader.setCustomModelResourceLocation(this, meta, location);
		}
