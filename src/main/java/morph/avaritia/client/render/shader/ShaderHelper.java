...
// TEMA: this is the main shader stuff, where the programs are loaded and
// compiled for the card.
// other relevant files are the shader in /assets/physis/shader/, and the tesr
// in /client/render/tile/
