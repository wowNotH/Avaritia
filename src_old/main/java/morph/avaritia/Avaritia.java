...
import static morph.avaritia.Avaritia.DEPENDENCIES;
...
@Mod(modid = MOD_ID, name = MOD_NAME, version = MOD_VERSION, acceptedMinecraftVersions = CodeChickenLib.MC_VERSION, dependencies = DEPENDENCIES)
