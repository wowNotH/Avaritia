...
public class Achievements {
	...
	public static void load() {
		...
		catalyst = new AvaritiaAchievement("catalyst", 6, -3, ModItems.infinity_catalyst, singularity).func_75987_b();
		infinity = new AvaritiaAchievement("infinity", 4, -6, ModItems.infinity_ingot, neutronium).func_75987_b();
		creative_kill = new AvaritiaAchievement("creative_kill", -6, -6, new ItemStack(Items.SKULL, 1, 3), null).func_75987_b();
